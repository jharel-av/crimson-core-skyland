...
execute at @a[tag=PapuCat] run function crimson_powers:passives/01_playmakers/02_xlejks/grp_detec
...
execute as @a[scores={cat_aura_timer=3600..}] run function crimson_powers:passives/01_playmakers/02_xlejks/remove_buff
