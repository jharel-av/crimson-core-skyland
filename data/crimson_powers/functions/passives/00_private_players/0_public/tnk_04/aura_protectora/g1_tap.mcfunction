...
execute as @a[distance=..5,tag=!aura_tank,tag=!tanque] run function crimson_powers:passives/00_private_players/0_public/tnk_04/aura_protectora/on
# 3. Buff al tanque.
execute if entity @s[tag=!aura_tank] run function crimson_powers:passives/00_private_players/0_public/tnk_04/aura_protectora/on_tank