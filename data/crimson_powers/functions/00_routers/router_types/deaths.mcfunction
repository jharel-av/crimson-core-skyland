...
# Ataque:
execute if entity @s[tag=atk] run function crimson_powers:03_pasivas/00_private_players/0_public/atk_01
# Movimiento:
execute if entity @s[tag=mov] run function crimson_powers:03_pasivas/00_private_players/0_public/mov_02
# Tanque:
execute if entity @s[tag=tanque] run function crimson_powers:03_pasivas/00_private_players/0_public/tnk_04/true
# Soporte:
execute if entity @s[tag=sup] run function crimson_powers:03_pasivas/00_private_players/0_public/sup_03/sup_03
