...
execute as @e[type=!player,distance=..8,tag=!stun_afectado,tag=!slowed_by_stun,tag=!stun_health_reduced] at @s run function crimson_powers:05_public/tank/stun_perfecto/apply_effects_to_target
execute as @a[tag=ene,tag=!tanque,distance=..8,tag=!stun_afectado,tag=!slowed_by_stun,tag=!stun_health_reduced] at @s run function crimson_powers:05_public/tank/stun_perfecto/apply_effects_to_target