...
execute if score @s mov_dash_cd matches 1.. run function crimson_powers:05_public/movility/impulso_subito/on_cooldown
execute if score @s mov_dash_cd matches 0 run function crimson_powers:05_public/movility/impulso_subito/use
