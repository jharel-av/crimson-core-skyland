...
# ---- On Cooldown ----
execute if score @s cd_aura matches 1.. run function crimson_powers:05_public/support/aura_sanacion/on_cooldown
# ---- Ready to Use ----
execute if score @s cd_aura matches ..0 run function crimson_powers:05_public/support/aura_sanacion/trigger
