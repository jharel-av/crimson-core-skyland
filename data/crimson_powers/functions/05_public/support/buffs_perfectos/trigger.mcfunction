...
execute as @a[distance=..10,tag=!ene] at @s run function crimson_powers:05_public/support/buffs_perfectos/apply_buffs
execute at @s run function crimson_powers:05_public/support/buffs_perfectos/apply_debuffs
