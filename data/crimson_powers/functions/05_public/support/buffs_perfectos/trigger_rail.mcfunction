...
# ---- On Cooldown ----
execute if score @s cd_ultimate matches 1.. run function crimson_powers:05_public/support/buffs_perfectos/on_cooldown
# ---- Ready to Use ----
execute if score @s cd_ultimate matches ..0 run function crimson_powers:05_public/support/buffs_perfectos/trigger
## --- Kill Item ---
