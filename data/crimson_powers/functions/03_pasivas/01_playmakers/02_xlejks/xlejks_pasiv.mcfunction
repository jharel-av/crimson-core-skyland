...
execute at @a[tag=PapuCat] run function crimson_powers:03_pasivas/01_playmakers/02_xlejks/grp_detec
...
execute as @a[scores={cat_aura_timer=3600..}] run function crimson_powers:03_pasivas/01_playmakers/02_xlejks/remove_buff
