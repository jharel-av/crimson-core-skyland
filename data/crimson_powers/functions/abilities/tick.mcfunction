...
execute as @a[scores={aura_duration=80}] at @s run function crimson_powers:abilities/support/aura_sanacion/on_aura_pulse
execute as @a[scores={aura_duration=60}] at @s run function crimson_powers:abilities/support/aura_sanacion/on_aura_pulse
execute as @a[scores={aura_duration=40}] at @s run function crimson_powers:abilities/support/aura_sanacion/on_aura_pulse
execute as @a[scores={aura_duration=20}] at @s run function crimson_powers:abilities/support/aura_sanacion/on_aura_pulse
# Finaliza el aura cuando el contador llega a 1.
execute as @a[scores={aura_duration=1}] run function crimson_powers:abilities/support/aura_sanacion/end_aura
# --- Buffs Perfectos (Ultimate) ---
# Finaliza la ultimate cuando el contador llega a 1.
execute as @a[scores={ultimate_duration=1}] run function crimson_powers:abilities/support/buffs_perfectos/remove_buffs

# --- Stun Perfecto (Timers de jugador y detección)
function crimson_powers:abilities/tank/stun_perfecto/tick
# --- Stun Perfecto (Timers de entidades afectadas)
function crimson_powers:abilities/tank/stun_perfecto/mobs_tick
