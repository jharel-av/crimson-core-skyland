...
execute as @e[tag=stun_afectado] at @s run function crimson_powers:abilities/tank/stun_perfecto/stunned_mob_logic

# --- 2. Lógica para entidades ralentizadas ---
execute as @e[tag=slowed_by_stun] at @s run function crimson_powers:abilities/tank/stun_perfecto/slowed_mob_logic
...
execute as @e[scores={health_reduction_duration=..0},tag=stun_health_reduced] at @s run function crimson_powers:abilities/tank/stun_perfecto/end_health_reduction
