...
execute if score @s buff_cd matches 1.. run function crimson_powers:abilities/attack/buff_normal/on_cooldown
execute if score @s buff_cd matches 0 run function crimson_powers:abilities/attack/buff_normal/use
