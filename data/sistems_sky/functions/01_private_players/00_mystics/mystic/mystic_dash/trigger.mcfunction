...
execute if entity @s[tag=apagar_dash] run function sistems_sky:01_private_players/00_mystics/mystic/mystic_dash/off
execute if entity @s[tag=prender_dash] run function sistems_sky:01_private_players/00_mystics/mystic/mystic_dash/on
