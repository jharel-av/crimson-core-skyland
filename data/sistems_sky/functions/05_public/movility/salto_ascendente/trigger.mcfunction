...
execute if score @s mov_leap_cd matches 1.. run function sistems_sky:05_public/movility/salto_ascendente/on_cooldown
execute if score @s mov_leap_cd matches 0 run function sistems_sky:05_public/movility/salto_ascendente/use
