...
# ---- On Cooldown ----
execute if score @s stun_perfecto_cd matches 1.. run function sistems_sky:05_public/tank/stun_perfecto/on_cooldown
# ---- Ready to Use ----
execute if score @s stun_perfecto_cd matches ..0 run function sistems_sky:05_public/tank/stun_perfecto/trigger
## --- Kill Item ---
