...
execute as @e[type=marker,tag=punto_guardado] unless score @s sky_id matches 1.. run function crimson_core:checkpoints/normal_ckpt/admin/lib/fix_single_checkpoint
