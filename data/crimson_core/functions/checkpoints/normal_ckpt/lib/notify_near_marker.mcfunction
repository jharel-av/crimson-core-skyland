# ===================================
# CRIMSON CORE - NORMAL CHECKPOINTS - LIB - NOTIFY NEAR MARKER
# ===================================
...
execute unless score @s acp_last = @s acp_temp run tellraw @s [{"text":"[Crimson Core]","color":"gold"},{"text":" ✓ Checkpoint guardado.","color":"green"}]
