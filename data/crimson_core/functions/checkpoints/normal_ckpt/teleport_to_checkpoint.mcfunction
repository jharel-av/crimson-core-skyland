# ===================================
# CRIMSON CORE - CHECKPOINTS - TELEPORT TO CHECKPOINT (MULTIPLAYER-SAFE)
...
tellraw @a[tag=normal_is_rescuing] [{"text":"[Crimson Core]","color":"gold"},{"text":" ¡Rescatado! Regresando al último checkpoint...","color":"aqua"}]
