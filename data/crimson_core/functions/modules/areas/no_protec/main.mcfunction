...
# Se ejecuta cada tick desde crimson_core:modules/areas/main
...
execute as @e[type=marker,tag=sl.zone.np] at @s run function crimson_core:modules/areas/no_protec/run_area_checks_for_marker

# 3. Chequea si la zona es nueva
function crimson_core:modules/areas/no_protec/check_new
